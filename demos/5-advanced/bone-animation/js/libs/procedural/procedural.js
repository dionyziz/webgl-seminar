define( [ 'libs/math', 'models/physics/universe', 'models/entity', 'libs/procedural/house' ], function( math, Universe, Entity, house  ) {
    ...
    var makeHouseMD = function( width, depth, floors, center ) {
	    ...
	    for ( var i = 0; i < floors; i++ ) {
	        ...
	        if ( window.length > 0 ) {
	            ...
	            windows.show();
                windows.move.apply( windows, center );
            }
	        ...
	        if ( balcony.length > 0 ) {
                ...
                balconies.show();
                balconies.move.apply( balconies, center );
            }
		    //
	    }
    };
